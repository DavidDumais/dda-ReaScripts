...
-- @provides 
--   dda_CURATE.lua
--   dda_ITEM - Select next item, move cursor to item, preserve play state.lua
--   dda_ITEM - Select previous item, move cursor to item, preserve play state.lua
--   dda_ITEM - Selected items information printout.lua
-- @changelog
--   v1.0.7
--   v1.0.6
--   v1.0.5
