-- @noindex
-- ReaScript Name: dda_CATEGORIZATION - Reorder Selected Items on a track based on item length - shortest to longest (1 second apart)
-- description: Repositions selected items on a track from the shortest to the longest item. Items are seperated from each other by 1 second.
-- author: David Dumais
