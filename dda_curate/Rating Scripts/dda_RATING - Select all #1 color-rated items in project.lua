-- @noindex
-- ReaScript Name: dda_RATING - Select all #1 color-rated items in project
-- description: Selects all items in project that are colored with the color rating #1. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- author: David Dumais
...
function selectItemsWithCustomColor(r, g, b)
    ...
    if r and g and b then
        ...
        --reaper.ShowConsoleMsg("Items with the first custom color have been selected.\n")
    else
