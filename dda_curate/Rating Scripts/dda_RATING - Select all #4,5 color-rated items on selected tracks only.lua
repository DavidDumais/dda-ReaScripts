-- @version 1.0.0
-- @description dda_RATING - Select all #4,5 color-rated items on selected tracks only
-- @about Selects all items on selected tracks that are colored with the color rating #4 or #5. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- @author David Dumais
