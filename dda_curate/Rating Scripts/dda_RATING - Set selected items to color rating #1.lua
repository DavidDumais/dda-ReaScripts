-- @noindex
-- ReaScript Name: dda_RATING - Set selected items to color rating #1
-- description: Changes the selected items color to the color set for rating color #1. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- author: David Dumais
