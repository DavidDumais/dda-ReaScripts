-- @noindex
-- ReaScript Name: dda_RATING - Select all #4,5 color-rated items in project
-- description: Selects all items in project that are colored with the color rating #4 or #5. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- author: David Dumais
...
-- Function to read RGB values from the custom_colors.txt file for the fourth and fifth custom colors
function readFourthAndFifthCustomColors()
    ...
    for i = 0, reaper.CountMediaItems(0) - 1 do
        ...
        if item then
            ...
            if itemR == r and itemG == g and itemB == b then
                ...
                -- Read RGB values for the fourth and fifth custom colors
                local customColors = readFourthAndFifthCustomColors()
                if customColors then
                    ...
                    --reaper.ShowConsoleMsg("Items with the fourth and fifth custom colors have been selected.\n")
                else
                    --reaper.ShowConsoleMsg("Failed to read RGB values for the fourth and fifth custom colors.\n")
                end
