-- @version 1.0.0
-- @description: dda_RATING - Select all #1,2 color-rated items in project
-- @about: Selects all items in project that are colored with the color rating #1 or #2. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- @author: David Dumais
