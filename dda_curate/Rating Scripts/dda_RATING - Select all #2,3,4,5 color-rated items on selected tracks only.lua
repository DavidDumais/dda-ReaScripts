-- @noindex
-- ReaScript Name: dda_RATING - Select all #2,3,4,5 color-rated items on selected tracks only
-- description: Selects all items on selected tracks that are colored with the color rating #2, #3, #4, or #5. Run the following script to set colors: dda_RATING - Show and change rating colors.lua
-- author: David Dumais
