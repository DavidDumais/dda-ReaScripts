-- @noindex
-- ReaScript Name: dda_METADATA - Add project metadata regions (all-in-one)
-- description: Adds a single region for each of the following: project name, artist, publisher, comments/notes, copyright. These regions will be used to fill metadata when exporting.
-- author: David Dumais
