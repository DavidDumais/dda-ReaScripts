-- @version 1.0.0
-- @description: dda_METADATA - Add project artist metadata region to selected items
-- @about: Adds a single region around all selected items and renames the region to user defined text. This region will be used to fill the artist metadata when exporting.
-- @author: David Dumais
