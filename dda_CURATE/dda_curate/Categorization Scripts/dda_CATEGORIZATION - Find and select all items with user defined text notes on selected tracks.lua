-- @noindex
-- ReaScript Name: dda_CATEGORIZATION - Find and select all items with user defined text notes on selected tracks
-- description: Prompts user for text, then finds and selects all items on the selected track whose notes match the user defined text.
-- author: David Dumais
