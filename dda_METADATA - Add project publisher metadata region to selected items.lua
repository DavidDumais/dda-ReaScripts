-- @noindex
-- ReaScript Name: dda_METADATA - Add project publisher metadata region to selected items
-- description: Adds a single region around all selected items and renames the region to user defined text. This region will be used to fill the publisher metadata when exporting.
-- author: David Dumais
